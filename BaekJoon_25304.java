...
public class BaekJoon_25304 {
    ...
    final int PRICE_INDEX = 0;
    final int NUMBER_INDEX = 1;

    BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in));

    public String isSamePrice() throws IOException {
        ...
        for(int i = 0 ; i < number ; i++) {
            ...
            inputPrice = Integer.parseInt(inputArray[PRICE_INDEX]);
            inputNumber = Integer.parseInt(inputArray[NUMBER_INDEX]);
            result += inputPrice * inputNumber;
        }
