...
public class BaekJoon_10810 {
    ...
    public void getNumberOfBalls() throws IOException {
        ...
        for (int index = 0; index < m; index++) {
            String[] iAndJAndK = bufferedReader.readLine().split(" ");
            int i = Integer.parseInt(iAndJAndK[0]);
            int j = Integer.parseInt(iAndJAndK[1]);
            String k = iAndJAndK[2];

            for (int newIndex = i - 1; newIndex < j; newIndex++) {
                buckets[newIndex] = k;
            }
        }
